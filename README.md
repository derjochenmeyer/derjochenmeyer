...
**AI Tooling:** Claude Code, Claude API, Anthropic SDK, OpenAI Codex
**Data & Analytics:** SQLite, BigQuery, Custom Dashboards
**Infrastructure:** Docker, DDEV, VPS
**Standards:** FHIR R5, Schema.org, JSON-LD
